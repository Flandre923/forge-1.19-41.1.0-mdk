...
public class FluidTankRenderer {
    ...
    private void drawTiledSprite(PoseStack poseStack, int tiledWidth, int tiledHeight, int fluidColor, long scaledAmount, TextureAtlasSprite sprite) {
